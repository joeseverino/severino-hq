...
register_tool(services.list_resource)
register_tool(services.get_resource)
...
register_tool(services.list_managed_resources)
register_tool(services.get_managed_resource)
register_tool(services.list_services)
register_tool(services.get_service)
